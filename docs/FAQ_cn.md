...
6.  **问： 在 `tools/train.py` 中，代码中是否首先在有标注数据集上训练，其目的是什么？（问题 [#26](../../../issues/26)）**
...
2.  **问： 在最大化/最小化不确定性的顺序和其固定的网络层方面，论文和代码之间有些差别。（问题 [#4](../../../issues/4)、[#16](../../../issues/16#issuecomment-859363894)、[#46](../../../issues/46#issuecomment-944126056)）**
...
8.  **问： 如何测试 50% 的数据量能否达到 100% 数据量的效果？（问题 [#46](../../../issues/46)）**
